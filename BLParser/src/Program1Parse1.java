...
public final class Program1Parse1 extends Program1 {
    ...
    private static String parseInstruction(Queue<String> tokens,
        ...
        Reporter.assertElseFatalError(!identifier.equals("move")
                && !identifier.equals("turnright")
                && !identifier.equals("turnleft")
                && !identifier.equals("infect") && !identifier.equals("skip"),
                "error");
        ...
        Reporter.assertElseFatalError(tokens.dequeue().equals(identifier),
                "Token should be the Indetifier");
    ...
    public void parse(Queue<String> tokens) {
        ...
        while (!tokens.front().equals("BEGIN")) {
            ...
            Statement instruction = new Statement1();
            String name = parseInstruction(tokens, instruction);
            context.add(name, instruction);
        }

        this.swapContext(context);

        Reporter.assertElseFatalError(tokens.dequeue().equals("BEGIN"),
                "Token should be BEGINS");
        ...
        Reporter.assertElseFatalError(
                ...
                "This should be the end of the input");
