...
public final class CryptoUtilities {
     ...
     * Constant for 0.
     */
    public static final NaturalNumber ZERO = new NaturalNumber2(0);

    /**
     * Constant for 1.
     */
    public static final NaturalNumber ONE = new NaturalNumber2(1);

    /**
     * Constant for 2.
     */
    public static final NaturalNumber TWO = new NaturalNumber2(2);

    /**
     * Constant for 4.
     */
    public static final NaturalNumber FOUR = new NaturalNumber2(4);
    ...
    public static void powerMod(NaturalNumber n, NaturalNumber p,
        ...
        if (p.equals(ZERO)) {
            ...
            if (isEven(p)) {
                NaturalNumber pDivideBy2 = new NaturalNumber2(p);
                pDivideBy2.divide(TWO);
                powerMod(n, pDivideBy2, m);
    ...
    public static boolean isWitnessToCompositeness(NaturalNumber w,
        ...
        NaturalNumber w1Copy = new NaturalNumber2(w);
        NaturalNumber w2Copy = new NaturalNumber2(w);

        boolean isWitness = false;

        powerMod(w1Copy, TWO, n);
        powerMod(w2Copy, nCopy, n);

        if (w1Copy.equals(ONE) || !w2Copy.equals(ONE)) {
            isWitness = true;
        }
    ...
    public static boolean isPrime2(NaturalNumber n) {
        ...
        if (n.compareTo(new NaturalNumber2(THREE)) <= 0) {
            ...
            for (int i = 0; i < FIFTY && isPrime; i++) {
                ...
                //Shifts interval from [0,n] to [2, n-2]
