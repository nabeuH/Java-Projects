...
public abstract class ListTest {
    ...
    //Retreat Test Cases
    @Test
    public final void testRetreatMakeZero() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(1, "ink");
        List<String> list2 = this.createFromArgsRef(0, "ink");
        /*
         * Call method under test
         */
        list1.retreat();
    ...
    @Test
    public final void testRetreatMakeZeroV2() {
        /*
         * Set up variables
         */
    ...
    @Test
    public final void testRetreatNonZero() {
        /*
         * Set up variables
         */
    ...
    @Test
    public final void testRetreatNonZeroV2() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(4, "yellow", "orange",
    ...
    @Test
    public final void testRetreatNonZeroLeftMore1RightMore0() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(2, "yellow", "orange",
