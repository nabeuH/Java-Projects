...
public final class RSSReader {
    ...
    private static void processItem(XMLTree item, SimpleWriter out) {
        ...
        if (linkIndx >= 0 && item.child(linkIndx).numberOfChildren() > 0) {
            hasLink = true;
            out.print("<a href=\"");
    ...
    public static void main(String[] args) {
        ...
        if (xml.label().equals("rss") && xml.hasAttribute("version")
            ...
            //creates .html file
            out.print(
                    "Enter the name of the html file to print to (with the .html): ");
            String htmlName = in.nextLine();
            SimpleWriter fileOut = new SimpleWriter1L("doc/" + htmlName);
